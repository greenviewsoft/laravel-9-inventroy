        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('credit.customer.pdf') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> Print Credit Customer  </i></a> <br>  <br>               
